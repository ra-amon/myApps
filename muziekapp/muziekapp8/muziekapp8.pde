...
// versie 8
//datum: 18-05-2014
// klik op de horizontale lijnen om de geluiden in te laden. Druk een knop in om
// vervolgens de geluiden die je weg wilt hebben te verwijderen.

// note to Kosmo
// ik wilde er nog voor zorgen dat hij de bolletjes tekende exact op de kruising, maar
// wanneer ik dit deed begon hij vreselijk te laggen. De lijn beweegt nu wel op de miliseconde
